...
namespace PostgreUrunProje
{
    public partial class FrmUrun : Form
    {
        ...
        NpgsqlConnection baglanti = new NpgsqlConnection("server=localHost; port=5432; Database=dburunler; user ID=postgres; password=Mine12345");
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            NpgsqlCommand komut = new NpgsqlCommand(" insert into urunler(urunid, urunad,stok,alisfiyat,satisfiyat,gorsel,kategori)" +
